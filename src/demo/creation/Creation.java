...
public class Creation 
{
	public static void main(String[] args) 
	{
		...
		cfg.addAnnotatedClass(Student.class); // either add the mapping in cfg file else do this
		...
		Transaction transaction = new Configuration().configure("hibernate.cfg.xml").addAnnotatedClass(Student.class).buildSessionFactory().getCurrentSession().beginTransaction();
